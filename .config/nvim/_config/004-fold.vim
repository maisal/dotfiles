...
set foldcolumn=4
"set fillchars=vert:\|
hi Folded gui=bold term=standout ctermbg=black ctermfg=green guibg=none guifg=lightgreen
hi FoldColumn gui=bold term=standout ctermbg=none ctermfg=green guibg=none guifg=lightgreen
